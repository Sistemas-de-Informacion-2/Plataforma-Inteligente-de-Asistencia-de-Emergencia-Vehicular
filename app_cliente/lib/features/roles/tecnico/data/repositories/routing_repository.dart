...
class RoutingRepository {
  ...
  /// Obtiene la ruta entre dos puntos llamando a nuestro backend.
  ...
  /// Recalcula la ruta y fuerza al backend a emitir por WS.
  Future<Map<String, dynamic>?> recalcularRuta({
    ...
    try {
      ...
      debugPrint('[RoutingRepo] Error recalculando ruta: ${e.message}');
    }
    return null;
  }
}
