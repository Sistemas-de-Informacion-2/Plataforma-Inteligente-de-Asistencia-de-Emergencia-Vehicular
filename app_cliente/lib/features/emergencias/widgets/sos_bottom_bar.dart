...
import 'package:fixo/features/emergencias/widgets/attachments_row.dart';
...
class SosBottomBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final hasAttachments = inicioProvider.imagenesSeleccionadas.isNotEmpty || inicioProvider.recordedAudio != null;
    return Align(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Área de texto o indicador de grabación
                      AnimatedSwitcher(
                      ...
                      // Fila de botones de acción (Más grandes para dedos gruesos)
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              iconSize: 32, // Más grande
                              constraints: const BoxConstraints(minWidth: 48, minHeight: 48), // Área táctil amplia
                              padding: EdgeInsets.zero,
                              onPressed: () => onShowAttachments(inicioProvider),
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                IconButton(
                                  icon: Icon(inicioProvider.isRecording ? Icons.stop_circle_rounded : Icons.mic_none_rounded),
                                  color: inicioProvider.isRecording ? AppTheme.danger : AppTheme.textSecondary,
                                  iconSize: 32, // Más grande
                                  constraints: const BoxConstraints(minWidth: 48, minHeight: 48), // Área táctil amplia
                                  padding: EdgeInsets.zero,
                                ...
                                _SendButton(
                                  ...
                                  onTap: inicioProvider.hasContent ? onSendSOS : () {},
                                ),
                              ],
                            ),
                          ],
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: TextField(
        ...
        style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: AppTheme.textPrimary),
      ...
      child: Row(
        children: [
          FadeTransition(
            opacity: _controller,
            child: Container(
              width: 12, height: 12, // Punto más grande
          ...
          const Text(
            ...
            style: TextStyle(color: AppTheme.danger, fontWeight: FontWeight.w600, fontSize: 16),
          ),
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        width: 48, // Área táctil más grande
        height: 48,
        decoration: BoxDecoration(
