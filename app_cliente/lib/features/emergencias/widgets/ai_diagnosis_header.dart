...
/// Header del diagnóstico de IA que se muestra en el BottomSheet de recomendaciones.
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Icon(_gravedadIcon(diagnostico.nivelGravedad), color: color, size: 22),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(Icons.psychology_rounded, color: AppTheme.textSecondary, size: 18),
